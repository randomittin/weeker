"""``atlas refill`` — the nightly loop glue (016 §T-50).
...
from atlas.generate.pipeline import GenerationReport, run_generation
from atlas.learn import status
from atlas.verify.bank_checks import BankReport, verify_bank
