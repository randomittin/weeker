...
* :func:`compose_caselet_items` — pick caselets to **maximise weak-concept
  ...
  6 + 3 shape;
* :func:`compose_full_items` — the 90 standalone (via :mod:`atlas.learn.mock`)
  followed by the 9 caselets, each as five positioned :class:`~atlas.learn.mock.MockItem`;
...
Scoring is the marks-weighted engine in :mod:`atlas.learn.mock` (per-question
...
from atlas.core.models import Attempt, Course, Mastery, Question
from atlas.generate.caselets import caselet_drill
from atlas.learn import elo, mock, predict
