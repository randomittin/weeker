...
:data:`~atlas.core.config.GEN_OVERGEN_FACTOR`, runs every candidate through the
...
shared :func:`atlas.core.embed.embed` client with an injectable transport; the
LLM calls (generation, G2, G3) go through :func:`atlas.core.llm.complete`, also
...
from atlas.core.llm import Transport
from atlas.core.models import Chunk, Concept, Course, Page, Question, Source
from atlas.generate import gates
from atlas.generate.calibrate import initial_q_rating
from atlas.generate.prompts import GeneratedQuestion, generate_for_concept, top_chunks
from atlas.generate.targets import compute_targets
