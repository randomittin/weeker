...
batch of :data:`~atlas.core.config.GEN_BATCH` questions and parses them through
the contract.
"""
...
from atlas.core.models import Chunk, Concept, ConceptChunk, Objective, Question
