"""Single source of tunables for Atlas.
...
MODEL_GENERATOR = os.getenv("ATLAS_MODEL_GENERATOR", "…")
MODEL_VERIFIER_CHEAP = os.getenv("ATLAS_MODEL_VERIFIER_CHEAP", "…")
MODEL_SOLVER_BLIND = os.getenv("ATLAS_MODEL_SOLVER_BLIND", "…-different-family")
MODEL_EMBED = os.getenv("ATLAS_MODEL_EMBED", "…")
EMBED_DIM = int(os.getenv("ATLAS_EMBED_DIM", "1536"))

# ── LLM / embed transport (env-overridable) ────────────────────────────────────
LLM_BASE_URL = os.getenv("ATLAS_LLM_BASE_URL", "https://api.openai.com/v1")
LLM_API_KEY = os.getenv("ATLAS_LLM_API_KEY", "")
EMBED_BASE_URL = os.getenv("ATLAS_EMBED_BASE_URL", "https://api.openai.com/v1")
EMBED_API_KEY = os.getenv("ATLAS_EMBED_API_KEY", "")
EMBED_BATCH = int(os.getenv("ATLAS_EMBED_BATCH", "64"))
CACHE_DIR = os.getenv("ATLAS_CACHE_DIR", ".atlas_cache")
