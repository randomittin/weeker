"""SQLAlchemy 2.0 declarative models — the full Atlas schema.
...
from atlas.core.types import IntArray, JSONType, TextArray, UuidArray, Vector


class Base(DeclarativeBase):
    """Declarative base for all Atlas models."""
