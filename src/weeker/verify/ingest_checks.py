...
from weeker.core.models import Chapter, Chunk, Page, Source
from weeker.ingest.structure import check_structure
...
def check_chunks(session: Session, course_id: uuid.UUID) -> list[str]:
    ...
    from weeker.ingest.textutil import count_tokens
