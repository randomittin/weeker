...
update; the hooks here read the same :class:`~weeker.learn.elo.UpdateResult`). Over
...
functions drive the ``weeker generate recalibrate`` maintenance command.
"""
...
from weeker.learn.elo import UpdateResult
